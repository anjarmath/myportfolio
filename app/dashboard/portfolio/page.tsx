    ...
    <div>
            ...
            </Link>
        {
            portfolios.map((portfolio)=>(
              ...
              >
                <Image alt={portfolio.image?.name?? ""} width={1000} height={1000} src={portfolio.image!.url} className=' w-[320px] h-[180px] object-cover'></Image>
                <div>
                  <div className="text-sm font-medium leading-none">{portfolio.title}</div>
