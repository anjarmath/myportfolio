    ...
    <main className=' scroll-smooth'>
        ...
        <div id='home' className=' px-4 py-16 bg-hprimary-dark'>
          <div className=' max-w-5xl mx-auto flex gap-8 flex-col-reverse md:flex-row items-center'>
            <div className=' flex-[3] flex flex-col gap-4'>
              <h1 className=' text-white font-bold text-4xl'><span className=' text-hprimary-light'>Congratulation!</span> 🙌, you have come to the right place!</h1>
              ...
              <Link href={'#contact'}>
                <button className=' text-white bg-hprimary px-6 py-4 rounded-lg hover:bg-hprimary-light hover:text-black transition-colors w-full md:w-auto'>Get Started</button>
              </Link>
            </div>
            ...
            <div className=' flex-[2]'>
              ...
              <Image width={3000} height={3000} alt='anjar' src={'/hero-image.png'}>
        ...
        <div id="profile" className=' px-5 py-8'>
          <div className=' max-w-5xl flex gap-6 flex-col md:flex-row mx-auto'>
            <div className=' flex-[2]'>
              <Image alt='' src={me?.image!.url ?? '/me.jpg'} width={1000} height={1000} className=' object-cover w-full aspect-square rounded-3xl border-2 border-hprimary-dark'/>
            </div>
            <div className=' flex-[3] flex flex-col gap-2'>
              ...
              <Link href={`${me?.resume!.url}`} className=' flex items-center gap-2 text-lg font-bold hover:text-hprimary transition-colors'>
                <LuDownload/>
                Resume
              </Link>
            </div>
                ...
                portfolios.map((portfolio)=>(
                  portfolio.is_show && <div key={portfolio.id} className=' rounded-xl bg-white p-3 shadow-lg md:w-[48%] hover:shadow-2xl border-2 hover:border-hprimary transition-all'>
                    ...
                    <div className=' flex my-5 gap-4'>
                      {portfolio.url &&
                        <Link href={portfolio.url} className=' flex gap-1 items-center hover:text-hprimary hover:underline transition-all'>
                          <FaArrowRightLong/> Try It
                        </Link>}
                      {portfolio.github_url &&
                        <Link href={portfolio.github_url} className=' flex gap-1 items-center hover:text-hprimary hover:underline transition-all'>
                          <LuGithub/> Github
                        </Link>}
                    </div>
                  </div>
        ...
        <div id='contact' className=' px-5 py-8'>
          <div className=' max-w-5xl rounded-xl bg-hprimary-dark p-4 mx-auto flex flex-col gap-3'>
              ...
              <h1 className=' text-white text-2xl font-bold'>Ready to get started?</h1>
              <p className=' text-white'>Feel free to contact me, let’s discuss about your vision!</p>
        ...
        <footer className=' p-5 flex justify-center bg-black'>
          <p className=' text-white'>Made with ❤ by Anjar Dwi Hariadi using NextJS.</p>
        </footer>
    </main>
  )
}
